            ...
            {currentStep < 2 ? (
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor:
                    saving || !form.nom.trim() || !form.description?.trim()
                      ? 'not-allowed'
                      : 'pointer',
                  fontWeight: 500,
                  opacity: saving || !form.nom.trim() || !form.description?.trim() ? 0.6 : 1,
                }}
              >
                {saving ? (
                  <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, flex: 1 }}>
              <div
                style={{
                  ...
                  border: `0.5px solid ${
                    currentStep > i ? '#639922' : currentStep === i ? '#534AB7' : '#ccc'
                  }`,
                }}
              >
                {currentStep > i ? '✓' : i + 1}
              ...
              <span
                style={{
                  fontSize: 10,
                  color: currentStep === i ? '#534AB7' : '#888',
