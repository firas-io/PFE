      ...
      <div className="table-responsive">
        <table className="table table-vcenter card-table">
          ...
          <tbody>
            {habits.map((h) => (
              <tr key={h.habit_id}>
                <td>
                  ...
                  {h.visible_pour_tous && <div className="text-secondary small">Habitude partagée</div>}
                </td>
                <td>{h.statut}</td>
            ...
            {!habits.length && (
              <tr>
                <td colSpan={6} className="text-secondary text-center py-4">Aucune habitude trouvée.</td>
              </tr>
            )}
          </tbody>
        </table>
