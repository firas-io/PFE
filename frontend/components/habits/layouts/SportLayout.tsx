      ...
      beforeFields={
        <div className="space-y-3">
          <div className="d-flex flex-wrap align-items-center gap-2">
            <span className="d-inline-flex align-items-center gap-1 rounded-pill bg-orange-500/15 px-2 py-1 text-[11px] fw-bold text-orange-600 dark:text-orange-400">
              <Zap className="h-3.5 w-3.5" aria-hidden />
              Intensité : {INTENSITY_LABEL[intensite] ?? "—"}
            </span>
            <span className="d-inline-flex align-items-center gap-1 rounded-pill bg-light px-2 py-1 text-[10px] fw-medium text-muted">
              <Activity className="h-3 w-3" aria-hidden />
              Suivi distance & durée
            </span>
          </div>
          <div className="w-100 min-w-0 rounded-4 border border-border/50 bg-muted/10 p-2">
