...
const updatePermissions = (s) => ({ method: "PATCH",  url: "/roles/:id/permissions",    preHandler: s.auth([s.verifyAccessToken, s.verifyAbility([{ action: "manage", subject: "Role" }])]), handler: RolesController.updatePermissions });
